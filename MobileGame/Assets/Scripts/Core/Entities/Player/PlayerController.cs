...
namespace Player
{
    public class PlayerController : MonoBehaviour
    {
            ...
            IHypeService hypeService)
        {
            ...
            _playerAttackHandler.Setup(_inputService, _tickeableService.GetTickManager, _enemyManager,
        ...
        public void ResetPlayer(float amountHype)
        {
            _playerMovementHandler.ResetMovePoint(_environmentSO.Index);
            _hypeService.SetHypePlayer(amountHype);
        }
    }
}